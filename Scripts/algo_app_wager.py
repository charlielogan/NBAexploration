...
from wager_system import optimal_wager
...
vegas_line = st.number_input("Enter betting line ", value = 0.0, step=0.5)
...
wag = optimal_wager( ans[0], vegas_line)


st.success("Estimated total final: " + str(ans[0]) + "\nWager $" + str(wag) + " on the " + is_over)
